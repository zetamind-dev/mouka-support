...
<div class="nav-scroller bg-white box-shadow">
    <nav class="nav nav-underline">
        ...
        <a class="nav-link {{ Request::is('admin/department*') ? 'active' : '' }}" href="{{ url( '/admin/department') }} ">Department</a>
        <a class="nav-link {{ Request::is('admin/users*') ? 'active' : '' }}" href="{{ url( '/admin/users') }} ">New Users</a>

        <a class="nav-link {{ Request::is('admin/logs*') ? 'active' : '' }}" href="{{ url( '/admin/logs') }} ">Logs</a>
        <a class="nav-link {{ Request::is('admin/reports*') ? 'active' : '' }}" href="{{ url( '/admin/reports') }} ">Reports</a>
        @else
        <a class="nav-link {{ Request::is('home*') ? 'active' : '' }}" href="{{ url( '/home') }} ">Dashboard</a>
        ...
        <a class="nav-link {{ Request::is('assets*') ? 'active' : '' }}" href="{{ url( '/assets') }} ">Asset</a>
