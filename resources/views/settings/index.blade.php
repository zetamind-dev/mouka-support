...
<div class="container col-md-6">
    <div class="col-md-10">
        <div class="card">
            <div class="card-header" style="background:#2737A6;color:white; font-size:17px; font-weight:bold;">Update Details</div>
            <div class="card-body">
                ...
                <form action="{{ url('/settings') }}" method="POST">
                    ...
                    <button type="submit" class="btn" style="background:#2737A6;color:white;font-weight:bold">Update </button>
                </form>
            </div>
        </div>
    </div>
