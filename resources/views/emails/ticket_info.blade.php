                                    ...
                                    <tr>
                                        <td bgcolor="#ffffff" width="100" align="left">
                                            <a href="https://www.mouka.com/">
                                                <img alt="Mouka" src="https://www.mouka.com/wp-content/uploads/2019/01/mouka-logo-new.png" width="52" height="78" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;"
                                                    border="0">
                                            </a>
                                        </td>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="right" alt="Quick Support" style="padding: 0 0 5px 0; font-size: 14px; font-family: Arial, sans-serif; color: #666666; text-decoration: none;">
                                                        <span style="color: #666666; text-decoration: none;">Mouka Support Portal -
                                                ...
                                                <tr>
                                                    <td class="padding-copy">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td>
                                                                    <img src="https://www.mouka.com/wp-content/uploads/2019/01/mouka-logo-new.png" border="0" alt="Mouka Limited" style="display: block; padding: 0; color: #666666; text-decoration: none; font-family: Helvetica, arial, sans-serif; margin-left:90px;font-size: 16px; width: 330px; height: 200px;"
                                                                        class="img-max">
                                                                </td>
                                                            </tr>
                                                        </table>
                            ...
                            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                                <tr>
                                    <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                        <span class="appleFooter" style="color:#666666;">All rights reserved © Made with &hearts; Mouka Support Portal</span>
                                        <br>
                                        <a class="original-only" style="color: #666666; text-decoration: none;">Adding Comfort to life</a>
