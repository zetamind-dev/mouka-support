...
<div class="container col-md-5 ">
    ...
    <form class="form-horizontal col-md-12" role="form" method="POST" action="{{ url('/tickets') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group{{ $errors->has('copy_email2') ? ' has-error' : '' }}">
            ...
            <div class="col-md-12">
                <input id="copy_email2" type="text" class="form-control" style="line-height: 40px;" name="copy_email2" value="{{ old('copy_email2') }}" maxlength="50"> @if ($errors->has('copy_email2'))
                    <span class="help-block">
